...
// blocked. Break out to a top-level page first; if a sandbox forbids it, record
// the state so the login page can offer a "open in new window" fallback.
if (escapeEmbeddedContext() === 'escaped') {
  // Top window is navigating to our URL; let that reload take over.
}
